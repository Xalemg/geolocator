...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="./index.php">Localizaciones</a>
      </li>
    </ul>
  </div>
</nav>
...
if ( $_GET ) {
    ...
    $query1 = $link1->query("DELETE FROM users WHERE mail = '$mail';");
    if( !$query1) {
        echo "Error en la query1 $link1->error";
        exit;
    } else {
        echo "<br><h1>Usuario borrado con exito</h1><br><br><br><br>";
